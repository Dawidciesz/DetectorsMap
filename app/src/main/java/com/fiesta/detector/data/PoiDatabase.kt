    ...
    class Callback @Inject constructor(
        ...
        override fun onCreate(db: SupportSQLiteDatabase) {
            ...
            applicationScope.launch {
                ...
                dao.insert(Poi("zname2", "descriptopn2", 54.03236756587204, 19.33108815051521))
                dao.insert(Poi("aname3", "descriptopn3", 53.985000064417505, 19.87172117427078))
                dao.insert(Poi("tname4", "descriptopn4", 53.440464997338296, 17.229029943180063))
                dao.insert(Poi("name5", "descriptopn5", 51.47430870070944, 21.085863280370916))
                dao.insert(Poi("bname6", "descriptopn6", 51.5700101917381, 16.713304557050854))
            }
        }
    }
}